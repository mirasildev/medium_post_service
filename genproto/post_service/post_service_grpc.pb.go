...
type PostServiceClient interface {
	...
	Get(ctx context.Context, in *GetPost, opts ...grpc.CallOption) (*Post, error)
	...
	Delete(ctx context.Context, in *DeletePost, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *postServiceClient) Get(ctx context.Context, in *GetPost, opts ...grpc.CallOption) (*Post, error) {
	out := new(Post)
...
func (c *postServiceClient) Delete(ctx context.Context, in *DeletePost, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedPostServiceServer) Get(context.Context, *GetPost) (*Post, error) {
...
func (UnimplementedPostServiceServer) Delete(context.Context, *DeletePost) (*empty.Empty, error) {
...
func _PostService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).Get(ctx, req.(*GetPost))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PostService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).Delete(ctx, req.(*DeletePost))
	}
	return interceptor(ctx, in, info, handler)
}
